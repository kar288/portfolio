...
class EditEmailForm(forms.ModelForm):
	class Meta:
		...
		fields = ('email', )
		widgets = {
			'email': grumblr.form_widget.GrumblrTextInput(attrs={'class' : 'form-control user-data', 'placeholder' : 'E-mail', 'value': ''}),
		}
...
class PostForm(forms.ModelForm):
	class Meta:
		...
		fields = ('content', )
		widgets = {
			'content': grumblr.form_widget.GrumblrTextInput(attrs={'class' : 'form-control', 'placeholder' : 'Go ahead and grumble', 'value': ''}),
		}
	...
	def is_valid(self):
		...
		self.fields['content'].widget.error = 'Max length of grumble is 50 chars!'
		self.fields['content'].widget.attrs['class'] += ' wrong'
		return False


class EditPasswordForm(forms.Form):
	password1 = forms.CharField(max_length = 200, 
								widget = grumblr.form_widget.GrumblrPasswordInput(attrs={'class' : 'form-control', 'placeholder' : 'New Password'}))
	password2 = forms.CharField(max_length = 200, 
								widget = grumblr.form_widget.GrumblrPasswordInput(attrs={'class' : 'form-control', 'placeholder' : 'Confirm Password'}))
